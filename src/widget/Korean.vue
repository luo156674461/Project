    ...
    <div>
      ...
      <div class="content">
        ...
        <div class="audit">
          ...
          <div class="auditclass">
            <div class="img" v-for="(item,index) in ListOne" :key="index">
            <img :src="ListOne[index].midCoverUrl" width="100%" height="200">
            </div>
          </div>
        </div>
        <div class="audit">
          ...
          <div class="auditclass">
            <div class="img" v-for="(i,index) in ListTwo" :key="index">
            <img :src="ListTwo[index].midCoverUrl" width="100%" height="200">
            </div>
          </div>
        </div>
      </div>
    ...
    this.axios.get('/api/korean')
      .then(res => {
        ...
        if (res.errno === 0) {
          ...
          this.ListOne = this.korean.ListOne
          this.ListTwo = this.korean.ListTwo
          this.asSchemeList = this.korean.asSchemeList
            this.$nextTick(() => {
