      ...
      <div class="content">
        ...
        <div class="audit">
          ...
          <div class="audit">
            ...
            <div class="auditclass">
              <div class="img" v-for="(i,index) in special" :key="index">
              <img :src="special[index].img_url" width="100%" height="200">
              </div>
            </div>
          </div>
          <div class="audit">
            ...
            <div class="auditclass">
              <div class="img" v-for="(item,index) in hotClass" :key="index">
               <img :src="hotClass[index].img_url" width="100%" height="200">
              </div>
            </div>
          </div>
        </div>
    ...
    this.axios.get('/api/japanese')
      .then(res => {
        ...
        if (res.errno === 0) {
          ...
          this.special = this.japanese.data.special
          this.hotClass = this.japanese.data.hotClass
          this.curriculum = this.japanese.data.curriculum
          this.asSchemeList = this.japanese.data.asSchemeList
